            ...
            <div className="container">
                <header className={styles.hero}>
                    ...
                    <div className={styles.actions}>
                        ...
                        {book.text_url && (
                            <Link href={`/read/${bookId}?format=text`} className={`${styles.button} ${styles.primaryButton}`}>
                                Read Now
                            </Link>
                        )}
                        {book.html_url && (
                            <Link href={`/read/${bookId}?format=html`} className={`${styles.button} ${styles.secondaryButton}`}>
                                View Original HTML
                            </Link>
                        )}
                    ...
                    <div className={styles.metaGrid}>
                        <div className={styles.metaItem}>
                            <label>Nippon Decimal Code</label>
                        ...
                        <div className={styles.metaItem}>
                            ...
                            <span>{book.copyright ? 'Yes' : 'Expired'}</span>
                        </div>
                    </div>
                </header>
                ...
                <section>
                    ...
                    {contributors.length > 0 ? (
                        ...
                        <p className="text-muted">No contributors recorded.</p>
                    )}
                </section>
            </div>
        </main>
